    ...
    <div className="min-w-0">
      ...
      {stats && (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          <Card>
            <CardHeader className="pb-1"><CardTitle className="text-sm font-medium text-muted-foreground">Tasdiqlash kutilmoqda (tovarlar)</CardTitle></CardHeader>
            <CardContent>
              <p className="text-2xl font-bold">{stats.pendingProductsCount ?? 0}</p>
              {(stats.pendingProductsCount ?? 0) > 0 && (
                <Link href="/admin/products?filter=pending" className="text-sm text-primary hover:underline mt-1 inline-block">Koʻrish →</Link>
              )}
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-1"><CardTitle className="text-sm font-medium text-muted-foreground">Tasdiqlash kutilmoqda (sharhlar)</CardTitle></CardHeader>
            <CardContent>
              <p className="text-2xl font-bold">{stats.pendingReviewsCount ?? 0}</p>
              {(stats.pendingReviewsCount ?? 0) > 0 && (
                <Link href="/admin/reviews?filter=pending" className="text-sm text-primary hover:underline mt-1 inline-block">Koʻrish →</Link>
              )}
            </CardContent>
          </Card>
        </div>
      ...
      <h2 className="text-lg font-semibold mb-3">Katalog va sozlamalar</h2>
