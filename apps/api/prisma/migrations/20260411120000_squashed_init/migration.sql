...
-- CreateEnum
CREATE TYPE "MarketplaceMode" AS ENUM ('MULTIVENDOR', 'SINGLE_SHOP');
...
CREATE TABLE "platform_settings" (
    "id" TEXT NOT NULL,
    "site_name" TEXT,
    "marketplace_mode" "MarketplaceMode" NOT NULL DEFAULT 'MULTIVENDOR',
...
-- CreateIndex
CREATE INDEX "users_staff_shop_id_idx" ON "users"("staff_shop_id");
...
-- AddForeignKey
ALTER TABLE "order_audit_events" ADD CONSTRAINT "order_audit_events_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "Order"("id") ON DELETE CASCADE ON UPDATE CASCADE;
